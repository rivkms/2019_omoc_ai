...
def deep_Q_learning():
    ...
    replay_memory = Replay_Memory(size_memory, size_batch)
    ...
    return dqn, num_episodes
    
#####################################################################
def run():
    dqn, num_episodes, num_trials = deep_Q_learning()
    
    dqn.save("./model/catch.ckpt" %environment)
